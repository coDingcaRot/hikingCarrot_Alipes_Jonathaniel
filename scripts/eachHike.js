...
function saveHikeDocumentIDAndRedirect(){
    let params = new URL(window.location.href) //get the url from the search bar of Google
    let ID = params.searchParams.get("docID"); 
    localStorage.setItem('hikeDocID', ID); //key value pairs, name which is hikeDocID and the ID which is the documents ID
    window.location.href = 'review.html'; //sends you to this window
}
