//gets the value stored in the localStorage of google with the specified name
//the value was stored in eachHike.html
var hikeDocID = localStorage.getItem("hikeDocID");    //visible to all functions on this page

//Goes through the hikes collection -> documents information 
// -> it grabs the data in the doc called name
// -> uses the data to populate the element we want
...
function writeReview() {
    ...
    if (user) {
        ...
        // Get the document for the current user and fill it up with values.
